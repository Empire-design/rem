                            ...
                            <div class="block-body">
                                <form id="form-data">
                                        ...
                                        <select name="idcategory" id="idcategory" class="form-control">
                                            ...
                                            @foreach (DB::table('categories')->get() as $categorys)
                                                <option value="{{ $categorys->id }}"
                                                    {{ $blog->idcategory == $categorys->id ? 'selected' : '' }}>
                                                    {{ $categorys->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="idsubcategory" id="idsubcategory" class="form-control">
                                            ...
                                            @foreach (DB::table('subcategories')->get() as $subcategorys)
                                                <option value="{{ $subcategorys->id }}"
                                                    {{ $blog->idsubcategory == $subcategorys->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="blogname" class="form-control"
                                            value="{{ $blog->name }}">
                                    </div>

                                    <!-- blog Price Input -->
                                    <div class="form-group">
                                        <label for="blogprice">blog Price</label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        ...
                        window.location.href = '{{ route('viewblog') }}';
                    } else {
                        alert("Blog has not been updated.");
                    }
                },
