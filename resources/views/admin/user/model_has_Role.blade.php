    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Model Has Role </li>
            </ul>
        </div>
        <section class="no-padding-top">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="block">
                            <div id="id" class="title"><strong class="d-block">Add model has Role</strong><span
                                    class="d-block"></span></div>
                            <div class="block-body">
                                <form id="id" action="{{ route('user.add') }}" method="POST">
                                    @csrf
